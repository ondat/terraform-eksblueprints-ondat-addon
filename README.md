...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_helm_addon"></a> [helm\_addon](#module\_helm\_addon) | github.com/aws-samples/terraform-aws-eks-blueprints//modules/kubernetes-addons/helm-addon | n/a |
