...
var (
	...
	destroyModules = []string{
		"module.eks_blueprints_kubernetes_addons.module.ondat[0].module.helm_addon",
	...
	expectedDeployments = [...]Deployment{
		...
		{"storageos-csi-helper", "storageos"},
		{"storageos-scheduler", "storageos"},
	}
	...
	expectedServices = [...]Services{
		...
		{"storageos-etcd", "storageos-etcd", "ClusterIP"},
		{"storageos", "storageos", "ClusterIP"},
		{"storageos-api-manager-metrics", "storageos", "ClusterIP"},
		{"storageos-webhook", "storageos", "ClusterIP"},
	}
)
